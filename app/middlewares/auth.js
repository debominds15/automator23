...
exports.registerValidation = [
  ...
  check("isRoleTypeDoctor", "Role Type is required").not().isEmpty(),
];
 ...
 */
 exports.scanValidation = [
  check("height", "Patient height is required").not().isEmpty(),
  check("weight", "Patient weight is required").not().isEmpty(),
  check("bmi", "Patient bmi is required").not().isEmpty(),
  check("fhr", "Patient fhr is required").not().isEmpty(),
  check("ga", "Patient ga is required").not().isEmpty(),
  check("mvp", "Patient mvp is required").not().isEmpty(),
  check("placentaLocation", "Patient placentaLocation is required").not().isEmpty(),
